 ...
 * @author Weix Sun
 */
@ConfigurationProperties("eureka.deployment")
public class EurekaDeploymentProperties {
	...
	public boolean equals(Object o) {
		...
		EurekaDeploymentProperties that = (EurekaDeploymentProperties) o;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("EurekaDeploymentProperties{");
